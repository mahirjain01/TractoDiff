...
python generate_streamline.py 
                --subject sub-1119 \
                --bundle AF_L \
                --dataset_file /med/TractoDiff/data/testset/sub-1119/sub-1119.hdf5 \
                --wm_loc /med/TractoDiff/data/testset/sub-1119/sub-1119-generated_approximated_mask.nii.gz \
                --model_path /med/TractoDiff/output_dir/models/TractoDiff_6.pth \

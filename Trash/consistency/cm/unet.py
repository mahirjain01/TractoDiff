...
class AttentionBlock(nn.Module):
    ...
    def __init__(
        ...
        # Always use QKVAttentionLegacy for GTX 1080
        self.attention = QKVAttentionLegacy(self.num_heads)
        self.attention_type = "regular"
...
class QKVAttentionLegacy(nn.Module):
    ...
    def forward(self, qkv):
        ...
        input_dtype = qkv.dtype  # Save the original dtype
        
        # Process in half precision for efficiency, but remember original type
        if input_dtype != th.float16:
            qkv = qkv.half()
